...
function charList($org)
{
	...
	foreach($org[charsIn] as $k)
	{
		...
		$content .= '<td><a href="'.$dir.'characters/'.$k.'">
		<img src="'.$dir.'characters/'.$k.'/avatar/(1).jpg" width="100" height="100" alt="'.$k.'" 
		title="'.$k.'" name="'.$k.'" onmouseover="this.src=\''.$dir.'characters/'.$k.'/avatar/(2).jpg\'"
		onmouseout="this.src=\''.$dir.'characters/'.$k.'/avatar/(1).jpg\'"></a><br>'.$k.'</td>';
...
'BlackKnights' => array(
	'meta' => array(
		'tags' => 'black knights, code geassarea ',
...
'Area11' => array(
	'meta' => array(
		...
		'title' => 'Area 11 - Code Geass Groups',
		'desc' => 'Code Geass Groups - Black Knights, Area 11, Geass Order, etc.'
	),
