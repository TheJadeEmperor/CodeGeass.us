...
if( isset( $_POST['join'] ) && $_POST['join'] == 'yes' ) {
   ...
   if( $_POST['password'] && $_POST['vpassword'] &&
      $_POST['vpassword'] == $_POST['password'] ) {
   ...
   if( $_POST['url'] && $_POST['url'] != 'n/a' && $_POST['url'] != 'N/A' &&
      $_POST['url'] != 'none' && $_POST['url'] != '-' ) {
      $url = clean( $_POST['url'] );
   ...
   if( count( $messages ) == 0 ) {
      ...
      $send_account_info = ( isset( $_POST['send_account_info'] ) &&
         $_POST['send_account_info'] == 'yes' ) ? true : false;
      $table = $info['dbtable'];
...
?>
   ...
   <input type="hidden" name="nonce" value="<?php echo $rand ?>:<?php echo
...
?>
         ...
         <input type="text" name="<?php echo $field ?>" value="<?php echo $values[$field]
