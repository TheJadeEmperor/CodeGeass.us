...
/*****************************************************************************
 ...
 http://enthusiast.seasonalplume.net
 ...
 http://enthusiast.seasonalplume.net/ is given. It is hoped that the script
...
if( isset( $_POST['email'] ) && $_POST['email'] != '' ) {
   ...
   if( !ereg( $matchstring, clean( $_POST['email'] ) ) ||
      !ctype_graph( clean( $_POST['email'] ) ) )  {
?>
...
?>
   ...
   Email address: </span>
   <input type="text" name="email" class="show_lostpass_email_field" />
